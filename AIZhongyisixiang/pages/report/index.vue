<template>
  <view class="page">
    <view class="hero">
      ...
      <view class="chips">
        <text class="chip">舌诊 · {{ report.status.tongue }}</text>
        <text class="chip">脉诊 · {{ report.status.pulse }}</text>
        <text class="chip">问诊 · {{ report.status.inquiry }}</text>
        <text class="chip">运气 · {{ report.status.climate }}</text>
      </view>
    </view>
...
<script>
import { getLatestReport } from "../../common/report-store";
